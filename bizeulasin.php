<table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="500" valign="top">
			<form action="index.php?SayfaKodu=8" method="post">
				<table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr height="40">
						<td style="color:#FF9900"><h3>Bize Ulaşın</h3></td>
					</tr>
					<tr height="30">
					...
					<tr height="40">
						<td align="left"><input type="submit" value="Mesajımı Gönder" class="YesilButon"></td>
					</tr>
				</table>
			</form>
		</td>
		...
		<td width="545" valign="top"><table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td colspan="2" align="left">Peak Games kullanıcı hesapları hakkında (Örneğin; Bilgi edinme, şifre talebi vb. gibi) herhangi bir yakını, arkadaşı vb. gibi 3. şahıslar tarafından gönderilen mesajlar.</td>
			</tr>
			<tr>
				<td colspan="2">&nbsp;</td>
			</tr>
